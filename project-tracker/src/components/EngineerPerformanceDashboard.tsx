        ...
        {userPerformance.length === 0 ? (
          ...
          <div className="space-y-6">
            {userPerformance.map(ep => (
              <div key={ep.user.id} className={`${theme.cardBg} rounded-lg p-6 border-2 border-white`}>
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <h2 className="text-2xl font-semibold">{ep.user.email}</h2>
                ...
                <div className="space-y-4">
                  {ep.tasks.map((task, idx) => {
                    ...
                    return (
                    <div key={idx} className={`border-2 rounded-lg p-4 ${getDelayColor()}`}>
